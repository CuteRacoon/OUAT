...
public class InteractionController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // »сключаем сам stayingGirlsObj из массива
        ...
        playerController.SetMovement(false); //можно закомментить дл€ возврата в нормальное положение
    }
    ...
    {
        cameraBehaviour.SwitchCamera(cameraAndTriggerIndex); //  амера сдвигаетс€ с учЄтом смещени€ индекса
